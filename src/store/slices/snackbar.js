...
const snackbar = createSlice({
    ...
    reducers: {
        openSnackbar(state, action) {
            ...
            // setting close to true to make sure all snack bars needs have the close button
            state.close = true;
            state.actionButton = actionButton || initialState.actionButton;
            // state.autoHideDuration = autoHideDuration===null ? autoHideDuration : autoHideDuration || initialState.autoHideDuration;
            // setting autoHideDuration to null to make sure all snack bars needs to be manually closed
