                ...
                <Grid container spacing={gridSpacing}>
                    ...
                    <Grid item xs={12}>
                        <MainCard>
                            ...
                            >
                                <Grid item xs={12}>
                                    <Link href="https://avrij.com/" target="_blank" underline="hover">
                                        <PublicTwoToneIcon color="secondary" /> https://avrij.com/
                                    </Link>
                                </Grid>
                                <Grid item xs={12}>
                                    <Link href="https://www.instagram.com/avrij" target="_blank" underline="hover">
                                        <InstagramIcon sx={{ color: theme.palette.orange.dark }} /> https://www.instagram.com/avrij
                                    </Link>
                                </Grid>
                                <Grid item xs={12}>
                                    <Link href="https://www.facebook.com/avrij" target="_blank" underline="hover">
                                        <FacebookIcon color="primary" /> https://www.facebook.com/avrij
                                    </Link>
                                </Grid>
                                <Grid item xs={12}>
                                    <Link href="https://in.linkedin.com/company/avrij" target="_blank" underline="hover">
                                        <LinkedInIcon sx={{ color: theme.palette.grey[900] }} /> https://in.linkedin.com/company/avrij
                                    </Link>
                                </Grid>
                            </Grid>
                        </MainCard>
