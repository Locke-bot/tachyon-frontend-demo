...
export const frameworks = [
    {
        title: 'Bootstrap 5',
        logo: Bootstrap,
        link: 'https://links.avrij.com/VpESi'
    },
    {
        title: 'Angular',
        logo: Angular,
        link: 'https://links.avrij.com/iNpKo'
    },
    {
        title: 'CodeIgniter',
        logo: Codeigniter,
        link: 'https://links.avrij.com/AdRiB'
    },
    {
        title: '.Net',
        logo: DotNet,
        link: 'https://links.avrij.com/wkQEu'
    },
    {
        title: 'Shopify',
        logo: Shopify,
    ...
    },
    {
        title: 'Vuetify 3',
        logo: Vue,
        link: 'https://links.avrij.com/RqhwV'
    },
    {
        title: 'Full Stack',
        logo: FullStack,
        link: 'https://links.avrij.com/quhuG'
    },
    {
        title: 'Django',
        logo: Django,
        link: 'https://links.avrij.com/Wfbiy'
    },
    {
        title: 'Flask',
        logo: Flask,
            ...
            <Container sx={{ mb: 6 }}>
                <Stack spacing={0.25} alignItems="center">
                    ...
                    <Typography variant="body2" align="center" sx={{ pt: 1 }}>
                        ...
                        <Link href="https://avrij.gitbook.io/berry/berry-eco-system" target="_blank" underline="hover">
                            learn more.
                        </Link>
                    </Typography>
                </Stack>
