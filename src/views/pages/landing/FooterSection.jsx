                                ...
                                <Grid container spacing={{ xs: 5, md: 2 }}>
                                    <Grid item xs={6} sm={3}>
                                        <Stack spacing={{ xs: 3, md: 5 }}>
                                            ...
                                            <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                                                <FooterLink href="https://links.avrij.com/HTIBc" target="_blank" underline="none">
                                                    Blog
                                                </FooterLink>
                                                <FooterLink href="https://avrij.gitbook.io/berry/" target="_blank" underline="none">
                                                    Documentation
                                                </FooterLink>
                                                <FooterLink
                                                    href="https://avrij.gitbook.io/berry/changelog"
                                                    target="_blank"
                                                    underline="none"
                                                >
                                                    Change Log
                                                </FooterLink>
                                                <FooterLink href="https://avrij.support-hub.io/" target="_blank" underline="none">
                                                    Support
                                                </FooterLink>
                                            </Stack>
                                        </Stack>
                                    ...
                                    <Grid item xs={6} sm={3}>
                                        <Stack spacing={{ xs: 3, md: 5 }}>
                                            ...
                                            <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                                                <FooterLink href="https://links.avrij.com/Yfkxg" target="_blank" underline="none">
                                                    Free React MUI
                                                </FooterLink>
                                                <FooterLink href="https://links.avrij.com/epTmN" target="_blank" underline="none">
                                                    Free Bootstrap 5
                                                </FooterLink>
                                                <FooterLink href="https://links.avrij.com/seQKN" target="_blank" underline="none">
                                                    Free Angular
                                                </FooterLink>
                                                <FooterLink href="https://links.avrij.com/Wfbiy" target="_blank" underline="none">
                                                    Free Django
                                                </FooterLink>
                                            </Stack>
                                        </Stack>
                    ...
                    >
                        <Stack direction="row" alignItems="center" spacing={{ xs: 3, sm: 1.5, md: 2 }}>
                            <IconButton
                                size="small"
                                component={Link}
                                href="https://links.avrij.com/HTIBc"
                                target="_blank"
                                aria-label="blog"
                            >
