            ...
            >
                        ...
                        <Grid item xs={12}>
                            ...
                            >
                                <Grid container spacing={2} sx={{ justifyContent: { xs: 'center', md: 'flex-start' } }}>
                                    ...
                                    <Grid item>
                                        <Button component={Link} href="https://links.avrij.com/hsqll" target="_blank" size="large">
                                            Purchase Now
                                        </Button>
                                    </Grid>
                                </Grid>
                ...
                <Grid item xs={12} md={7} sx={{ display: { xs: 'none', md: 'flex' } }}>
                    <Box sx={{ position: 'relative', mt: 8.75, zIndex: 9 }}>
                        <HeaderImage src={dashboard} alt="mlbchat" />
                        <Box
                            sx={{
                                position: 'absolute',
                                top: { md: -35, lg: -110 },
                        ...
                        >
                            <motion.div
                                ...
                                transition={{ type: 'spring', stiffness: 150, damping: 30, delay: 0.2 }}
                            >
                                <HeaderAnimationImage src={widget1} alt="mlbchat" />
                            </motion.div>
                        </Box>
                        <Box
                            sx={{
                        ...
                        >
                            <motion.div
                                ...
                                transition={{ type: 'spring', stiffness: 150, damping: 30, delay: 0.4 }}
                            >
                                <HeaderAnimationImage src={widget2} alt="mlbchat" />
                            </motion.div>
                        </Box>
                    </Box>
