...
import { Avatar, ButtonBase, Checkbox, Chip, ListItemButton, ListItemIcon, ListItemText, Typography, useMediaQuery } from '@mui/material';
...
const NavItem = ({ item, level, parentId, isParents = false }) => {
    ...
    const { selectedSources } = useSelector((state) => state.chat);
            ...
            {layout === LAYOUT_CONST.VERTICAL_LAYOUT || (layout === LAYOUT_CONST.HORIZONTAL_LAYOUT && matchDownMd) ? (
                ...
                >
                    <ButtonBase aria-label="theme-icon" sx={{ borderRadius: `${borderRadius}px` }} disableRipple={drawerOpen}>
                        ...
                        >
                            <Checkbox 
                                checked={item.id==='All Sources' && !selectedSources.length ? true : selectedSources.includes(item.id)}
                            />
                        </ListItemIcon>
                    </ButtonBase>
